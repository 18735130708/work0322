                    ...
                    <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                        ...
                        <div class="form-group">
                            <div class="field field-icon-right">
                                ...
                                <span class="icon icon-user margin-small"></span><font color="red">${error}</font>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="field field-icon-right">
                        ...
                        <div class="form-group">
                            <div class="field">
                                ...
                                <img id="img" src="${path}/user/img" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;">
...
<script>
    $(function () {
        ...
        $("#img").click(function () {
            let date = new Date();
            $("#img").attr("src","${path}/user/img?"+date);
        });
    })
</script>
</body>
